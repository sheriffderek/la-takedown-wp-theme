( function( $ ){
    ...
    $.fn.factoryBootstrap459_gradientControl = function (option) {
    ...
    $.fn.factoryBootstrap459_gradientControl.Constructor = GradientControl;
    
    // GRADIENT CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-459 .factory-gradient").factoryBootstrap459_gradientControl();
    });
