( function($) {
	...
	$.fn.factoryBootstrap459_dropdownControl = function(option) {
	...
	$.fn.factoryBootstrap459_dropdownControl.Constructor = DropdownControl;

	// AUTO CREATING
	// ================================

	$(function() {
		$(".factory-bootstrap-459 .factory-dropdown").factoryBootstrap459_dropdownControl();
	});
