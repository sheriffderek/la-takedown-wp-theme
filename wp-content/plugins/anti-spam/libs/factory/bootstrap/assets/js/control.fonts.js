...
;( function( $ ){
    ...
    $.widget( "factoryBootstrap459.fontControl", {
    ...
    $(function(){
        $.widget.bridge( "factoryBootstrap459_fontControl", $.factoryBootstrap459.fontControl );
        $(".factory-bootstrap-459 .factory-font").factoryBootstrap459_fontControl({});
    });
