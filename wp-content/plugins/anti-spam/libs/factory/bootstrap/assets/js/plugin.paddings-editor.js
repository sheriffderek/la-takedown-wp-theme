( function( $ ){
    ...
    $.fn.factoryBootstrap459_paddingsEditor = function (option) {
    ...
    $.fn.factoryBootstrap459_paddingsEditor.Constructor = PaddingsEditor;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-459 .factory-paddings-editor").factoryBootstrap459_paddingsEditor();
    });
