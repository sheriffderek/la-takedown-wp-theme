(function($) {
	...
	$.fn.factoryBootstrap459_checkboxControl = function(option) {
	...
	$.fn.factoryBootstrap459_checkboxControl.Constructor = CheckboxControl;

	// AUTO CREATING
	// ================================

	$(function() {
		$(".factory-bootstrap-459 .factory-checkbox.factory-buttons-way").factoryBootstrap459_checkboxControl();
		$(".factory-bootstrap-459 .factory-checkbox").not('.factory-buttons-way').click(function() {
