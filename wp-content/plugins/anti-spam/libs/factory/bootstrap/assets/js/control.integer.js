( function( $ ){
    ...
    $.fn.factoryBootstrap459_integerControl = function (option) {
    ...
    $.fn.factoryBootstrap459_integerControl.Constructor = IntegerControl;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-459 .factory-integer").factoryBootstrap459_integerControl();
    });
