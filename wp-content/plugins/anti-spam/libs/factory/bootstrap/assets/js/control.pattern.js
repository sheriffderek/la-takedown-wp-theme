...
;( function( $ ){
    ...
    $.widget( "factoryBootstrap459.patternControl", {
        ...
        showColorPanel: function() {
            ...
            this.$colorResult.val( this.$colorContol.factoryBootstrap459_colorControl('getValue') );
            this.$colorResult.trigger('change');
            this.$element.trigger('change');
        },
    ...
    $(function(){
        $.widget.bridge( "factoryBootstrap459_patternControl", $.factoryBootstrap459.patternControl );
        $(".factory-bootstrap-459 .factory-pattern").factoryBootstrap459_patternControl({});
    });
