...
;( function( $ ){
    ...
    $.widget( "factoryBootstrap459.colorControl", {
        ...
        _init: function( event ) {
            ...
            this.$picker.factoryBootstrap459_iris(irisOptions); 
            this.$picker.off('focus');

            $(document).on("click.color.factory", function(){
               self.$picker.factoryBootstrap459_iris("hide");  
            });

            this.$picker.add(this.$background).on("click.color.factory", function(e){
               e.stopPropagation();
               self.$picker.factoryBootstrap459_iris("show");  
            });  
        },
        ...
        hidePicker: function() {
            ...
            this.$picker.factoryBootstrap459_iris( 'hide' );
        }, 

        showPicker: function() {
            this.$element.addClass('factory-picker-active');
            this.$picker.factoryBootstrap459_iris( 'show' );
        },
    ...
    $(function(){
        $.widget.bridge( "factoryBootstrap459_colorControl", $.factoryBootstrap459.colorControl );
        $(".factory-bootstrap-459 .factory-color").factoryBootstrap459_colorControl({});
    });
