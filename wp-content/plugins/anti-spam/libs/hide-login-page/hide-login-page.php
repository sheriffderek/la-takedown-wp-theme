...
$whlp_plugin_info = array(
	...
	'load_factory_modules' => array(
		array('libs/factory/bootstrap', 'factory_bootstrap_459', 'admin'),
		array('libs/factory/forms', 'factory_forms_455', 'admin'),
		array('libs/factory/pages', 'factory_pages_457', 'admin'),
		array('libs/factory/templates', 'factory_templates_110', 'all'),
		array('libs/factory/adverts', 'factory_adverts_000', 'admin')
	)
);

$whlp_compatibility = new Wbcr_Factory458_Requirements(__FILE__, array_merge($whlp_plugin_info, array(
