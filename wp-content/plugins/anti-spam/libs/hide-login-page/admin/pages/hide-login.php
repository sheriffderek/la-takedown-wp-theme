...
class WHLP_HideLoginPage extends WBCR\Factory_Templates_110\Pages\PageBase {
	...
	protected function getNewLoginUrl() {
		...
		if ( \WBCR\Factory_Templates_110\Helpers::isPermalink() ) {
			return \WBCR\Factory_Templates_110\Helpers::userTrailingslashit( home_url( '/' ) . $login_path );
		} else {
